export const module2Slides = [
  ...
  // Document Processing Exercise
  {
    ...
    content: [
      ...
      "შექმენით ეფექტური პრომფტი მონაცემთა ექსტრაქციისთვის და შეაფასეთ მისი ეფექტურობა ქვემოთ მოცემული ინსტრუმენტით.",
    ...
    promptConfig: {
      type: 'technical',
      criteria: [
        "მონაცემთა ტიპების სპეციფიკაცია",
        "საჭირო ანალიზის მკაფიო აღწერა",
        "გამოსავლის ფორმატის განსაზღვრა",
        "კონტექსტის მიწოდება",
        "კონკრეტული შედეგების მითითება",
        "იერარქიული სტრუქტურის მოთხოვნა"
      ],
